...
class ModelCatalogueFormsPluginGrailsPlugin {
    ...
    def title = "Model Catalogue Forms Plugin" // Headline display name of the plugin
    def author = "Vladimir Orany"
    def authorEmail = "vladimir@orany.cz"
    def description = '''\
Forms generator plugin for Model Catalogue
'''

    // URL to the plugin's documentation
    def documentation = "http://grails.org/plugin/model-catalogue-forms-plugin"
